...
const GuestSavePrompt: React.FC<GuestSavePromptProps> = ({ 
  ...
  return (
    <div className="bg-blue-600/90 text-white p-4 rounded-lg mb-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        {onDismiss && (
          <Button 
            ...
            size="sm"
            onClick={onDismiss}
            className="text-white hover:bg-blue-700/20 text-sm px-3 py-1 h-8"
          >
            Continue as Guest
          </Button>
        )}
